...
export default function RealtimeChatTestPage() {
  ...
  const [targetUserForReview, setTargetUserForReview] = useState<{
    id: string;
    nickname: string;
    avatar?: string;
    animalType?: string;
  ...
  const handleGameSelectConfirm = async (game: {
    ...
    if (!roomId || !isConnected || !otherMember || !user?.id) {
      return;
    }
  ...
  const handleReviewSubmit = async (answers: {
    ...
    if (!targetUserForReview || !user?.id) {
      return;
    }
    ...
    >
      ...
      {targetUserForReview && (
        <ReviewModal
          ...
          targetUserNickname={targetUserForReview.nickname}
          targetUserAvatar={targetUserForReview.avatar}
          targetUserAnimalType={targetUserForReview.animalType}
        />
      )}
    </div>
  );
